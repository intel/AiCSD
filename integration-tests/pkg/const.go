...
const (
	...
	GetJobUrl              = "http://localhost:59784/api/v1/job"
...
const (
	...
	ServiceFileWatcher          = "file-watcher_1"
	ServiceDataOrg              = "data-organizer_1"
	ServiceSenderOem            = "file-sender-oem_1"
	ServiceReceiverGW           = "file-receiver-gateway_1"
	ServiceJobRepo              = "job-repository_1"
	ServiceTaskLauncher         = "task-launcher_1"
	ServiceSenderGW             = "file-sender-gateway_1"
	ServiceReceiverOem          = "file-receiver-oem_1"
	ServicePipelineSim          = "pipeline-sim_1"
	ServicePipelineVal          = "pipeline-val_1"
	ServiceConsul               = "edgex-core-consul_1"
	ServiceRedis                = "edgex-redis_1"
	ServiceAppMQTTExport        = "app-mqtt-export_1"
	ServiceKong                 = "kong_1"
	ServiceKongDb               = "kong-db_1"
	ServiceSecurityBootstrapper = "security-bootstrapper_1"
	ServiceProxySetup           = "security-proxy-setup_1"
	ServiceSecretStoreSetup     = "seturity-secretstore-setup_1"
	ServiceVault                = "vault_1"
